...
public class DAO <T extends Object> extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase database) {
		...
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (1,'bv1111248','12345',1,'Danilo Oliveira Bezerra','1988-08-03','Twistão','21','Aguaí','daniloob_361@hotmail.coml','(19)99329-5108',NULL,6);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (2,'bv1110977','123456',1,'Ricardo Borges Júnior','1988-04-19','Oráculo','Lady Night','São João da Boa Vista','ricardoborges.jr@gmail.com','(19)99323-2716',NULL,2);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (3,'bv111090x','123456',1,'Maximilian Silva Chiocheti','1988-04-12','Max','Banco do Brasil','São João da Boa Vista','mchiocheti@hotmail.com','(19)98175-1505',NULL,1);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (4,'bv1111019','123456',1,'Jessé Cuzini Gestin','1988-04-15','Bigorna','Corujas Noturnas','Vargem Grande do Sul','jessegestin@gmail.com','(19)98287-6259',NULL,2);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (5,'bv1111132','123456',1,'Tiago Modena','1988-04-13','Papai','Gogo-Boy','Vargem Grande do Sul','tiagoantoniomodena@gmail.com','(19)99399-2055',NULL,3);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (6,'bv1110993','123456',1,'Simone Consentino Jus','1988-04-20','Si','Casa Cristal','São João da Boa Vista','simone.jus@bol.com.br','(19)98170-8648',NULL,1);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (7,'bv1111124','123456',1,'Samara Ribeiro Vieira ','1988-04-20','Sah Jonas',NULL,'São João da Boa Vista','samara_skatmusic@hotmail.com','(19)98349-9013',NULL,2);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (8,'bv1111051','123456',1,'Daiane Ribeiro Pereira','1988-04-20','Daiane','Sercon Web','São João da Boa Vista','daianegalvao123@hotmail.com','',NULL,2);");
	    database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (9,'bv1011073','123456',1,'Lucas Grabert','1988-04-20','Lucas','','Itatinga','smartzig@gmail.com','(19)9999-7777',NULL,2);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (10,'bv1110837','123456',1,'Marcio Delarolle','1988-04-20','Marcio','Unimed Leste-Paulista','São João da Boa Vista','marcio.delarolle@gmail.com',NULL,NULL,6);");
	    database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (11,'bv1110195','123456',1,'Felipe Baldon Benutti','1988-04-20','Pelps','Simpliss Ltda','São João da Boa Vista','fbenuti@gmail.com','(19)9190-0948',NULL,5);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (12,'bv1110799','12345',1,'Michele Hermann','1988-04-20','MiHermann','Departamento de Saúde','São João da Boa Vista','michele.hermann@hotmail.com','',NULL,6);");
		...
		database.execSQL("INSERT INTO areainteresse (idAreaInteresse,Nome,Tipo) VALUES (6,'Informática',1);");
		database.execSQL("INSERT INTO areainteresse (idAreaInteresse,Nome,Tipo) VALUES (7,'Automação',1);");
		database.execSQL("INSERT INTO areainteresse (idAreaInteresse,Nome,Tipo) VALUES (8,'Eletrônica',1);");
