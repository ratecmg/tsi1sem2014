...
public class DAO <T extends Object> extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase database) {
		...
		/* 
		 * SENHAS 'CRIPTOGRAFADAS' usando o algoritimo SHA-256 não alterar!!! Exceto se você adicionar uma hash gerada por esse algoritimo
		 * as senhas para efetuar login são 123456 para todos usuarios 
		 * 
		 */
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (1,'bv1111248','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',1,'Danilo Oliveira Bezerra','00/00/0000','Twistão','21','Aguaí','daniloob_361@hotmail.coml','(19)99329-5108',NULL,6);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (2,'bv1110977','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',1,'Ricardo Borges Júnior','00/00/0000','Oráculo','Lady Night','São João da Boa Vista','ricardoborges.jr@gmail.com','(19)99323-2716',NULL,2);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (3,'bv111090x','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',1,'Maximilian Silva Chiocheti','00/00/0000','Max','Banco do Brasil','São João da Boa Vista','mchiocheti@hotmail.com','(19)98175-1505',NULL,1);");
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (4,'bv1111019','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',1,'Jessé Cuzini Gestin','00/00/0000','Bigorna','Corujas Noturnas','Vargem Grande do Sul','jessegestin@gmail.com','(19)98287-6259',NULL,2);");
		...
		database.execSQL("INSERT INTO usuario (idUsuario,Prontuario,Senha,Nivel,Nome,Nascimento,Apelido,LocalTrabalho,Cidade,Email,Telefone,Foto,EstadoCivil_idEstadoCivil) VALUES (8,'bv1111051','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92',1,'Daiane Ribeiro Pereira','00/00/0000','Daiane','Sercon Web','São João da Boa Vista','daianegalvao123@hotmail.com','',NULL,2);");
